// ── (No localStorage keys needed — data lives in data.json via the server) ──
...
let userData     = null;
let entries      = [];
let pendingAlert = null;   // replaces localStorage alert key
let chart        = null;
...
// Convenience wrappers kept so call-sites stay readable
function saveUser(data)  { userData = data; saveData(); }
function saveEntries()   { saveData(); }
